...
expr_moran[0] = (ctxt->vstateTab == NULL), low_moran[0] = -1, high_moran[0] = -1;
        expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(601, 1, 0, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0]) {
...
expr_moran[0] = (tmp == NULL), low_moran[0] = -1, high_moran[0] = -1;
        expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(602, 1, 0, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0]) {
...
expr_moran[0] = (elemDecl != NULL) && (elemDecl->etype == XML_ELEMENT_TYPE_ELEMENT), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(603, 1, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
expr_moran[0] = (elemDecl->contModel == NULL), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(604, 1, 1, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0])
...
expr_moran[0] = (ctxt == NULL) || (elem == NULL), low_moran[0] = -1, high_moran[0] = -1;
expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(1601, 1, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
	return(0);
expr_moran[0] = (elem->type != XML_ELEMENT_DECL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(1602, 1, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
	return(0);
expr_moran[0] = (elem->etype != XML_ELEMENT_TYPE_ELEMENT), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(1603, 1, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
	return(1);
    /* TODO: should we rebuild in this case ? */
expr_moran[0] = (elem->contModel != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1604, 1, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
...
expr_moran[0] = (ctxt->am == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1605, 1, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
...
expr_moran[0] = (xmlRegexpIsDeterminist(elem->contModel) != 1), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1606, 1, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
	char expr[5000];  // 1 valid.c:843
	expr[0] = 0;
	xmlSnprintfElementContent(expr, 5000, elem->content, 1);  // 2 valid.c:845
	xmlErrValidNode(ctxt, (xmlNodePtr) elem,
...
expr_moran[0] = (elemDecl->contModel == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1502, 1, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0])
...
fail:
	...
	if (ctxt != NULL) {
	    ...
	    expr[0] = 0;
	    xmlSnprintfElementContent(&expr[0], 5000, cont, 1);  // 2 valid.c:5527
	    list[0] = 0;
#ifndef LIBXML_REGEXP_ENABLED
	    if (repl != NULL)
...
expr_moran[0] = (ctxt == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(501, 1, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
        return(0);
/* printf("PushElem %s\n", qname); */
expr_moran[0] = (ctxt->vstateNr > 0) && (ctxt->vstate != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(502, 1, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
...
expr_moran[0] = (elem == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1401, 1, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) return(0);
    switch (elem->type) {
        case XML_ATTRIBUTE_NODE:
...
expr_moran[0] = (elemDecl == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(1402, 1, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
	return(0);
     ...
     */
expr_moran[0] = (ctxt->vstateNr == 0), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1403, 1, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
    /* Check that the element content matches the definition */
expr_moran[0] = elemDecl->etype == XML_ELEMENT_TYPE_ELEMENT, low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//         mdafl_gc_log(1404, 1, 1, low_moran, high_moran, expr_moran, 0);
        switch(elemDecl->etype) {
        case XML_ELEMENT_TYPE_UNDEFINED:
...
expr_moran[0] = (elem == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1301, 1, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) return(0);
     ...
     */
expr_moran[0] = (elem->type == XML_ENTITY_REF_NODE), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(1303, 1, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
	return(1);
    }
