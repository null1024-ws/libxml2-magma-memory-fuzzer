...
expr_moran[0] = (node->ns == NULL) || (node->ns->prefix == NULL), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(401, 1, 1, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0]) {
...
#ifdef LIBXML_SCHEMAS_ENABLED
expr_moran[0] = (reader->validate == XML_TEXTREADER_VALIDATE_RNG) && (reader->rngValidCtxt != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(401, 2, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
	int ret;

expr_moran[0] = (reader->rngFullNode != NULL), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(402, 2, 0, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0]) return;
	ret = xmlRelaxNGValidatePushElement(reader->rngValidCtxt,
	                                    reader->ctxt->myDoc,
					    node);
expr_moran[0] = (ret == 0), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(403, 2, 1, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0]) {
	    /*
...
xmlTextReaderValidateEntity(xmlTextReaderPtr reader) {
    ...
    do {
expr_moran[0] = (node->type == XML_ENTITY_REF_NODE), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(301, 2, 0, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0]) {
...
xmlTextReaderDoExpand(xmlTextReaderPtr reader) {
    ...
    if ((reader == NULL) || (reader->node == NULL) || (reader->ctxt == NULL))
        return(-1);
    do {
expr_moran[0] = (reader->ctxt->instate == XML_PARSER_EOF), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(602, 2, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0]) return(1);

expr_moran[0] = (xmlTextReaderGetSuccessor(reader->node) != NULL), low_moran[0] = -1, high_moran[0] = -1;
        expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(603, 2, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
	    return(1);
expr_moran[0] = reader->ctxt->nodeNr, low_moran[0] = DBL_MIN, high_moran[0] = reader->depth;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(604, 2, 0, low_moran, high_moran, expr_moran, 1);
if (expr_moran[0] < high_moran[0])
	    return(1);
expr_moran[0] = (reader->mode == XML_TEXTREADER_MODE_EOF), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(605, 2, 0, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0])
	    return(1);
...
expr_moran[0] = (reader == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(201, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0])
	return(-1);
    reader->curnode = NULL;
expr_moran[0] = (reader->doc != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(202, 2, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
        return(xmlTextReaderReadTree(reader));
expr_moran[0] = (reader->ctxt == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(203, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0])
	return(-1);
    ...
    DUMP_READER
#endif
expr_moran[0] = (reader->mode == XML_TEXTREADER_MODE_INITIAL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(204, 2, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
...
expr_moran[0] = (reader == NULL) || (reader->node == NULL), low_moran[0] = -1, high_moran[0] = -1;
expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(501, 2, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
        return(NULL);
expr_moran[0] = (reader->doc != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(502, 2, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
        return(reader->node);
expr_moran[0] = (reader->ctxt == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(503, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0])
        return(NULL);
