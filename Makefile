...
am_libxml2_fuzzer_OBJECTS =  \
	libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.$(OBJEXT) \
	libxml2_fuzzer-afl_driver.$(OBJEXT) \
	libxml2_fuzzer-FuzzedDataProvider.$(OBJEXT)
libxml2_fuzzer_OBJECTS = $(am_libxml2_fuzzer_OBJECTS)
libxml2_fuzzer_DEPENDENCIES = libxml2.la
libxml2_fuzzer_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(libxml2_fuzzer_CFLAGS) $(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o \
	$@
...
SOURCES = $(libxml2_la_SOURCES) $(testdso_la_SOURCES) \
	$(libxml2_fuzzer_SOURCES) $(runsuite_SOURCES) \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	AUTHORS COPYING ChangeLog NEWS README TODO compile \
...
ACLOCAL = ${SHELL} /Beacon/beacon_fuzzing/libxml2/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /Beacon/beacon_fuzzing/libxml2/missing autoconf
AUTOHEADER = ${SHELL} /Beacon/beacon_fuzzing/libxml2/missing autoheader
AUTOMAKE = ${SHELL} /Beacon/beacon_fuzzing/libxml2/missing automake-1.15
AWK = gawk
BASE_THREAD_LIBS = 
C14N_OBJ = c14n.c
...
CFLAGS = -g -fno-omit-frame-pointer -fcommon -Wno-error
CPP = wllvm -E
CPPFLAGS = 
CYGPATH_W = echo
...
LIBXML_VERSION_INFO = 11:12:9
LIBXML_VERSION_NUMBER = 20912
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
...
LZMA_LIBS = -llzma
MAINT = 
MAKEINFO = ${SHELL} /Beacon/beacon_fuzzing/libxml2/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MODULE_EXTENSION = .so
...
Z_CFLAGS = 
Z_LIBS = -lz
abs_builddir = /Beacon/beacon_fuzzing/libxml2
abs_srcdir = /Beacon/beacon_fuzzing/libxml2
abs_top_builddir = /Beacon/beacon_fuzzing/libxml2
abs_top_srcdir = /Beacon/beacon_fuzzing/libxml2
ac_ct_AR = ar
ac_ct_CC = wllvm
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Beacon/beacon_fuzzing/libxml2/install-sh
...
# Add the libxml2 fuzzer source
libxml2_fuzzer_SOURCES = \
    fuzz/libxml2_xml_reader_for_file_fuzzer.c \
    fuzz/afl_driver.c \
    fuzz/FuzzedDataProvider.c

libxml2_fuzzer_CFLAGS = \
    -I$(top_srcdir)/include \
    -I$(top_srcdir)/fuzz

libxml2_fuzzer_LDADD = libxml2.la -lz -lm -llzma
...
libxml2_fuzzer$(EXEEXT): $(libxml2_fuzzer_OBJECTS) $(libxml2_fuzzer_DEPENDENCIES) $(EXTRA_libxml2_fuzzer_DEPENDENCIES) 
	@rm -f libxml2_fuzzer$(EXEEXT)
	$(AM_V_CCLD)$(libxml2_fuzzer_LINK) $(libxml2_fuzzer_OBJECTS) $(libxml2_fuzzer_LDADD) $(LIBS)
...
include ./$(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Po
include ./$(DEPDIR)/libxml2_fuzzer-afl_driver.Po
include ./$(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Po
...
libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.o: fuzz/libxml2_xml_reader_for_file_fuzzer.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -MT libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.o -MD -MP -MF $(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Tpo -c -o libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.o `test -f 'fuzz/libxml2_xml_reader_for_file_fuzzer.c' || echo '$(srcdir)/'`fuzz/libxml2_xml_reader_for_file_fuzzer.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Tpo $(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Po
#	$(AM_V_CC)source='fuzz/libxml2_xml_reader_for_file_fuzzer.c' object='libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -c -o libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.o `test -f 'fuzz/libxml2_xml_reader_for_file_fuzzer.c' || echo '$(srcdir)/'`fuzz/libxml2_xml_reader_for_file_fuzzer.c

libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.obj: fuzz/libxml2_xml_reader_for_file_fuzzer.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -MT libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.obj -MD -MP -MF $(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Tpo -c -o libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.obj `if test -f 'fuzz/libxml2_xml_reader_for_file_fuzzer.c'; then $(CYGPATH_W) 'fuzz/libxml2_xml_reader_for_file_fuzzer.c'; else $(CYGPATH_W) '$(srcdir)/fuzz/libxml2_xml_reader_for_file_fuzzer.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Tpo $(DEPDIR)/libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.Po
#	$(AM_V_CC)source='fuzz/libxml2_xml_reader_for_file_fuzzer.c' object='libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -c -o libxml2_fuzzer-libxml2_xml_reader_for_file_fuzzer.obj `if test -f 'fuzz/libxml2_xml_reader_for_file_fuzzer.c'; then $(CYGPATH_W) 'fuzz/libxml2_xml_reader_for_file_fuzzer.c'; else $(CYGPATH_W) '$(srcdir)/fuzz/libxml2_xml_reader_for_file_fuzzer.c'; fi`

libxml2_fuzzer-afl_driver.o: fuzz/afl_driver.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -MT libxml2_fuzzer-afl_driver.o -MD -MP -MF $(DEPDIR)/libxml2_fuzzer-afl_driver.Tpo -c -o libxml2_fuzzer-afl_driver.o `test -f 'fuzz/afl_driver.c' || echo '$(srcdir)/'`fuzz/afl_driver.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/libxml2_fuzzer-afl_driver.Tpo $(DEPDIR)/libxml2_fuzzer-afl_driver.Po
#	$(AM_V_CC)source='fuzz/afl_driver.c' object='libxml2_fuzzer-afl_driver.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -c -o libxml2_fuzzer-afl_driver.o `test -f 'fuzz/afl_driver.c' || echo '$(srcdir)/'`fuzz/afl_driver.c

libxml2_fuzzer-afl_driver.obj: fuzz/afl_driver.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -MT libxml2_fuzzer-afl_driver.obj -MD -MP -MF $(DEPDIR)/libxml2_fuzzer-afl_driver.Tpo -c -o libxml2_fuzzer-afl_driver.obj `if test -f 'fuzz/afl_driver.c'; then $(CYGPATH_W) 'fuzz/afl_driver.c'; else $(CYGPATH_W) '$(srcdir)/fuzz/afl_driver.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libxml2_fuzzer-afl_driver.Tpo $(DEPDIR)/libxml2_fuzzer-afl_driver.Po
#	$(AM_V_CC)source='fuzz/afl_driver.c' object='libxml2_fuzzer-afl_driver.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -c -o libxml2_fuzzer-afl_driver.obj `if test -f 'fuzz/afl_driver.c'; then $(CYGPATH_W) 'fuzz/afl_driver.c'; else $(CYGPATH_W) '$(srcdir)/fuzz/afl_driver.c'; fi`

libxml2_fuzzer-FuzzedDataProvider.o: fuzz/FuzzedDataProvider.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -MT libxml2_fuzzer-FuzzedDataProvider.o -MD -MP -MF $(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Tpo -c -o libxml2_fuzzer-FuzzedDataProvider.o `test -f 'fuzz/FuzzedDataProvider.c' || echo '$(srcdir)/'`fuzz/FuzzedDataProvider.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Tpo $(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Po
#	$(AM_V_CC)source='fuzz/FuzzedDataProvider.c' object='libxml2_fuzzer-FuzzedDataProvider.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -c -o libxml2_fuzzer-FuzzedDataProvider.o `test -f 'fuzz/FuzzedDataProvider.c' || echo '$(srcdir)/'`fuzz/FuzzedDataProvider.c

libxml2_fuzzer-FuzzedDataProvider.obj: fuzz/FuzzedDataProvider.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -MT libxml2_fuzzer-FuzzedDataProvider.obj -MD -MP -MF $(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Tpo -c -o libxml2_fuzzer-FuzzedDataProvider.obj `if test -f 'fuzz/FuzzedDataProvider.c'; then $(CYGPATH_W) 'fuzz/FuzzedDataProvider.c'; else $(CYGPATH_W) '$(srcdir)/fuzz/FuzzedDataProvider.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Tpo $(DEPDIR)/libxml2_fuzzer-FuzzedDataProvider.Po
#	$(AM_V_CC)source='fuzz/FuzzedDataProvider.c' object='libxml2_fuzzer-FuzzedDataProvider.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libxml2_fuzzer_CFLAGS) $(CFLAGS) -c -o libxml2_fuzzer-FuzzedDataProvider.obj `if test -f 'fuzz/FuzzedDataProvider.c'; then $(CYGPATH_W) 'fuzz/FuzzedDataProvider.c'; else $(CYGPATH_W) '$(srcdir)/fuzz/FuzzedDataProvider.c'; fi`
