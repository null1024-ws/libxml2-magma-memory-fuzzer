...
xmlXIncludeParseFile(xmlXIncludeCtxtPtr ctxt, const char *URL) {
    ...
    pctxt = xmlNewParserCtxt();  // 2 xinclude.c:433
expr_moran[0] = (pctxt == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(701, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
...
expr_moran[0] = (inputStream == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(702, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
    ...
    xmlParseDocument(pctxt);  // 3 xinclude.c:474
...
if (expr_moran[0])
	return(-1);
expr_moran[0] = nr, expr_moran[1] = nr;
    low_moran[0] = ctxt->incNr, low_moran[1] = DBL_MIN;
    high_moran[0] = DBL_MAX, high_moran[1] = 0;
//     mdafl_gc_log(502, 2, 0, low_moran, high_moran, expr_moran, 0);
    if ((expr_moran[0] >= low_moran[0]) || (expr_moran[0] < high_moran[1]))
	return(-1);
    cur = ctxt->incTab[nr]->ref;
expr_moran[0] = (cur == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(503, 2, 0, low_moran, high_moran, expr_moran, 0);
     ...
     */
    href = xmlXIncludeGetProp(ctxt, cur, XINCLUDE_HREF);
expr_moran[0] = (href == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(504, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
	href = xmlStrdup(BAD_CAST ""); /* @@@@ href is now optional */
	if (href == NULL)
	    return(-1);
    ...
    parse = xmlXIncludeGetProp(ctxt, cur, XINCLUDE_PARSE);
expr_moran[0] = (parse != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(505, 2, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
expr_moran[0] = xmlStrEqual(parse, XINCLUDE_PARSE_XML), low_moran[0] = -1, high_moran[0] = -1;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// 	mdafl_gc_log(506, 2, 1, low_moran, high_moran, expr_moran, 0);
	if (expr_moran[0])
	    xml = 1;
	else if (xmlStrEqual(parse, XINCLUDE_PARSE_TEXT))
	    xml = 0;
...
expr_moran[0] = (URI == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(507, 2, 0, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
	xmlChar *escbase;
	xmlChar *eschref;
	/*
...
xmlXIncludeDoProcess(xmlXIncludeCtxtPtr ctxt, xmlDocPtr doc, xmlNodePtr tree,
	...
	return(-1);
expr_moran[0] = (skipRoot) && (tree->children == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
...
expr_moran[0] = (ctxt == NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
// mdafl_gc_log(403, 2, 0, low_moran, high_moran, expr_moran, 0);
if (expr_moran[0])
	return(-1);

expr_moran[0] = (doc->URL != NULL), low_moran[0] = -1, high_moran[0] = -1;
    expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//     mdafl_gc_log(404, 2, 1, low_moran, high_moran, expr_moran, 0);
    if (expr_moran[0]) {
	ret = xmlXIncludeURLPush(ctxt, doc->URL);
expr_moran[0] = ret, low_moran[0] = DBL_MIN, high_moran[0] = 0;
	expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//         mdafl_gc_log(405, 2, 0, low_moran, high_moran, expr_moran, 1);
	...
	/* TODO: need to work on entities -> stack */
        if (xmlXIncludeTestNode(ctxt, cur) == 1) {
             ...
             * of replacements.
             */
expr_moran[0] = ctxt->incTotal, low_moran[0] = 20, high_moran[0] = DBL_MAX;
            expr_moran[1] = -1, low_moran[1] = -1, high_moran[1] = -1;
//             mdafl_gc_log(406, 2, 0, low_moran, high_moran, expr_moran, 1);
